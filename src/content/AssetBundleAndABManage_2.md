...
![assetbundle menu item](http://unity3d.com/sites/default/files/assetbundle_menu_item.png){: width='30%'}  
...
![assetbundles folder](http://unity3d.com/sites/default/files/assetbundles_folder.png){: width='70%'}  
